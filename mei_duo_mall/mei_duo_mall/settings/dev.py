"""
Django settings for mei_duo_mall project.
...
ROOT_URLCONF = 'mei_duo_mall.urls'
...
WSGI_APPLICATION = 'mei_duo_mall.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PORT': 3306,  # 数据库端口
        'USER': 'mei_duo',  # 数据库用户名
        'PASSWORD': 'mei_duo_mall',  # 数据库用户密码
        'NAME': 'mei_duo_mall'  # 数据库名字
    }
}
